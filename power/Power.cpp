...
#define LOG_TAG "android.hardware.power@1.3-service.axon7"
...
#define TAP_TO_WAKE_NODE "/proc/touchscreen/wake_gesture"
#endif
...
constexpr char kPowerHalConfigPath[] = "/vendor/etc/powerhint.xml";
